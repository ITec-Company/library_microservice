...
func TestAuthorHandler_GetAll(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorService, limit, offset int)
	...
	testTable := []struct {
	...
	}{
		{
			...
			limit:  0,
			offset: 0,
			mockBehavior: func(s *mock_service.MockAuthorService, limit, offset int) {
				s.EXPECT().GetAll(limit, offset).Return([]*domain.Author{domain.TestAuthor(), domain.TestAuthor()}, nil)
			},
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			AuthorHandler := http.NewAuthorHandler(service, logger)
...
func TestAuthorHandler_GetByUUID(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorService, uuid string)
	...
	testTable := []struct {
	...
	}{
		{
			...
			input: "1",
			uuid:  "1",
			mockBehavior: func(s *mock_service.MockAuthorService, uuid string) {
				s.EXPECT().GetByUUID(uuid).Return(domain.TestAuthor(), nil)
			},
			expectedStatusCode:  200,
...
func TestAuthorHandler_Create(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorService, dto domain.CreateAuthorDTO)
	...
	testTable := []struct {
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockAuthorService, dto domain.CreateAuthorDTO) {
...
func TestAuthorHandler_Update(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAuthorService, dto *domain.UpdateAuthorDTO)
	...
	testTable := []struct {
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockAuthorService, dto *domain.UpdateAuthorDTO) {
