...
func TestReviewHandler_GetAll(t *testing.T) {
	type mockBehavior func(s *mock_service.MockReviewService, limit, offset int)
	...
	testTable := []struct {
	...
	}{
		{
			...
			limit:  0,
			offset: 0,
			mockBehavior: func(s *mock_service.MockReviewService, limit, offset int) {
				s.EXPECT().GetAll(limit, offset).Return([]*domain.Review{domain.TestReview(), domain.TestReview()}, nil)
			},
	...
	for _, testCase := range testTable {
		t.Run(testCase.name, func(t *testing.T) {
			...
			ReviewHandler := http.NewReviewHandler(service, logger)
...
func TestReviewHandler_GetByUUID(t *testing.T) {
	type mockBehavior func(s *mock_service.MockReviewService, uuid string)
	...
	testTable := []struct {
	...
	}{
		{
			...
			input: "1",
			uuid:  "1",
			mockBehavior: func(s *mock_service.MockReviewService, uuid string) {
				s.EXPECT().GetByUUID(uuid).Return(domain.TestReview(), nil)
			},
			expectedStatusCode:  200,
...
func TestReviewHandler_Create(t *testing.T) {
	type mockBehavior func(s *mock_service.MockReviewService, dto domain.CreateReviewDTO)
	...
	testTable := []struct {
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockReviewService, dto domain.CreateReviewDTO) {
...
func TestReviewHandler_Update(t *testing.T) {
	type mockBehavior func(s *mock_service.MockReviewService, dto *domain.UpdateReviewDTO)
	...
	testTable := []struct {
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockReviewService, dto *domain.UpdateReviewDTO) {
